...
def test_very_close_contact_threshold_is_strictly_below_two_angstrom():
    ...
    # "possible-clash" is no longer distance-driven — it's decided by app.clashes (VDW overlap).
    assert "possible-clash" not in contact_categories(protein, ligand, "protein-ligand", 1.999)
